...
eval { $v .= pmver('CPANPLUS::Dist::Base','any version') };
eval { $v .= pmver('CPANPLUS::Error','any version') };
...
eval { $v .= pmver('Pod::POM','any version') };
eval { $v .= pmver('Pod::POM::View::Text','any version') };
